  ...
  $.get("/getOfferTx?agreementId="+agreementId, function(response){
		...
		$.each(response.records, function(i, item) {
			...
			if(eventName=="LOC Document uploaded"){
				 document.getElementById('locUploadTime').innerHTML='  - '+convdataTime;
				  $("#locUploadTime").fadeIn(2000);
				  document.getElementById('txId5').innerHTML='{<a href="#" style="color:blue;" onclick=check("LOC_Document_uploaded")>'+item.transactionHash+'</a>}';	
				  $("#txId5").fadeIn(2000);
			...
			if(eventName=="LOC Document validated"){
				 document.getElementById('finalApproval').innerHTML='  - '+convdataTime;
				  ...
				  document.getElementById('txId6').innerHTML='{<a href="#" style="color:blue;" onclick=check("LOC_Document_validated")>'+item.transactionHash+'</a>}';	
				  $("#txId6").fadeIn(2000);
			}
